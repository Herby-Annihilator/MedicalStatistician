...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class TypeOfJudgmentController : DefaultCrudController<TypeOfJudgment>
    {
        public TypeOfJudgmentController(ICrudRepository<TypeOfJudgment> repository) : base(repository)
        {
        }
    }
}
