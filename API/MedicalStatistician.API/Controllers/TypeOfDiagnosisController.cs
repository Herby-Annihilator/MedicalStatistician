...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class TypeOfDiagnosisController : DefaultCrudController<TypeOfDiagnosis>
    {
        public TypeOfDiagnosisController(ICrudRepository<TypeOfDiagnosis> repository) : base(repository)
        {
        }
    }
}
