...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class PlaceOfDepartureController : DefaultCrudController<PlaceOfDeparture>
    {
        public PlaceOfDepartureController(ICrudRepository<PlaceOfDeparture> repository) : base(repository)
        {
        }
    }
}
