...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class DisabilityGroupController : DefaultCrudController<DisabilityGroup>
    {
        public DisabilityGroupController(ICrudRepository<DisabilityGroup> repository) : base(repository)
        {
        }
    }
}
