...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class CauseOfDeathController : DefaultCrudController<CauseOfDeath>
    {
        public CauseOfDeathController(ICrudRepository<CauseOfDeath> repository) : base(repository)
        {
        }
    }
}
