...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class CauseOfDisabilityController : DefaultCrudController<CauseOfDisability>
    {
        public CauseOfDisabilityController(ICrudRepository<CauseOfDisability> repository) : base(repository)
        {
        }
    }
}
