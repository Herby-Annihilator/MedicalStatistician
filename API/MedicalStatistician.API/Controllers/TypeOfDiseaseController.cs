...
namespace MedicalStatistician.API.Controllers
{
    ...
    [ApiController]
    public class TypeOfDiseaseController : DefaultCrudController<TypeOfDisease>
    {
        public TypeOfDiseaseController(ICrudRepository<TypeOfDisease> repository) : base(repository)
        {
        }
    }
}
